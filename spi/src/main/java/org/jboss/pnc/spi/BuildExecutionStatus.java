...
public enum BuildExecutionStatus {
    ...
    COLLECTING_RESULTS_FROM_REPOSITORY_MANAGER_PROCESSING_DEPENDENCIES,
    COLLECTING_RESULTS_FROM_REPOSITORY_MANAGER_PROCESSING_BUILT_ARTIFACTS,
    COLLECTING_RESULTS_FROM_REPOSITORY_MANAGER_REMOVE_BUILD_AGGREGATION_GROUP,
    COLLECTING_RESULTS_FROM_REPOSITORY_MANAGER_PROMOTION_BUILD_CONTENT_SET,
