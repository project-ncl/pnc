...
public class Build extends BuildRef {
    ...
    private Build(ProjectRef project, SCMRepository repository, Environment environment, Map<String, String> attributes, User user, BuildConfigurationRevisionRef buildConfigurationRevision, List<Integer> dependentBuildIds, List<Integer> dependencyBuildIds, Integer id, Date submitTime, Date startTime, Date endTime, BuildCoordinationStatus status, String buildContentId, Boolean temporaryBuild) {
