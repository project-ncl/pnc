...
import org.jboss.pnc.rest.api.swagger.response.SwaggerSingletons;
...
public interface BaseEndpoint<T> {
    ...
    @Operation(summary = "Gets all.",
            responses = {
                    @ApiResponse(responseCode = SUCCESS_CODE, description = SUCCESS_DESCRIPTION,
                            content = @Content(schema = @Schema(implementation = SwaggerPages.ProjectPage.class))),
    ...
    @Path("/{id}")
    public T update(
            @Parameter(description = ID) @PathParam("id") String id, T object);

    @Operation(summary = "Updates an existing object.",
            responses = {
    ...
    @DELETE
    @Path("/{id}")
    public T deleteSpecific(@Parameter(description = ID) @PathParam("id") String id);
