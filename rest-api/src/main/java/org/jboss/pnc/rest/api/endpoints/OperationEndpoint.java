...
public interface OperationEndpoint {
    ...
    static final String CREATE_NEW_DEL_ANALYZER_DESC = "Creates a new deliverable analyzer operation or updates endTime and status of an existing one.";
    ...
    /**
     * {@value CREATE_NEW_DEL_ANALYZER_DESC}
     * 
     * @param operation
     * @return
     */
    @Operation(
            summary = CREATE_NEW_DEL_ANALYZER_DESC,
            responses = {
                    @ApiResponse(
    ...
    DeliverableAnalyzerOperation createNewOrUpdate(@NotNull DeliverableAnalyzerOperation operation);
     ...
     */
    @Operation(
            summary = UPDATE_DEL_ANALYZER_DESC,
    ...
    DeliverableAnalyzerOperation getSpecific(@Parameter(description = OP_ID) @PathParam("id") String id);
