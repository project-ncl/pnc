...
public class EAPModulesAccessTest {
    ...
    public static EnterpriseArchive deploy() {
        EnterpriseArchive ear = Deployments.baseEarWithTestDependencies();
        WebArchive restWar = ear.getAsType(WebArchive.class, AbstractTest.REST_WAR_PATH);
        restWar.addClass(EAPModulesAccessTest.class);
        return ear;
    }
