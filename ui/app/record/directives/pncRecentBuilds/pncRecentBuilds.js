...
(function () {
  ...
  module.directive('pncRecentBuilds', [
    ...
    'BuildRecordDAO',
    'eventTypes',
    function (PncCache, BuildRecordDAO, eventTypes) {
      ...
      return {
        ...
        link: function (scope) {
          ...
          scope.page = PncCache.key('pnc.record.pncRecentBuilds').key('page').getOrSet(function() {
            return BuildRecordDAO.getAllPaged();
          }).then(function(page) {
            page.reload();
            return page;
          }).then(function(page) {
