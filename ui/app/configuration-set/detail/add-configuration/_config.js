...
(function() {
  ...
  module.config(['$stateProvider', function($stateProvider) {
    ...
    $stateProvider.state('configuration-set.detail.add-configuration', {
      url: '/add-configuration',
      views: {
        '@configuration-set': {
          templateUrl: 'configuration-set/detail/add-configuration/configuration-set.add-configuration.html',
