...
public class BasicModelTest extends AbstractModelTest {
    ...
    public void testCreateBuildRecordAndArtifacts() {
        ...
        BuildRecord buildRecord1 = BuildRecordAll.Builder.newBuilder()
                .id(1)
    ...
    public void testBuildRecordPreventsAddingDuplicateArtifacts() {
        ...
        BuildRecord buildRecord = BuildRecordAll.Builder.newBuilder().id(2).buildConfigurationAudited(buildConfigAud)
