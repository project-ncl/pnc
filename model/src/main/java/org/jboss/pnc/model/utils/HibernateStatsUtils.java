...
public class HibernateStatsUtils {
    ...
    public static SortedMap<String, Map<String, HibernateMetric>> getSecondLevelCacheEntitiesStats(Statistics statistics) {
        ...
        if (statistics.isStatisticsEnabled()) {
            ...
            Stream.of(entityNames).forEach(eN -> {
                ...
                // Entity cache stats
                entityStatMap.put("cache.region.name", createHibernateMetricItem("cacheRegionName",
                        "The name of the region where this data is cached.", entityStat.getCacheRegionName()));
                entityStatMap.put("cache.hit.count", createHibernateMetricItem("cacheHitCount",
                ...
                entityStatMap.put("cache.miss.count", createHibernateMetricItem("cacheMissCount",
                ...
                entityStatMap.put("update.count",
                        createHibernateMetricItem("updateCount",
    ...
    public static SortedMap<String, Map<String, HibernateMetric>> getSecondLevelCacheCollectionsStats(Statistics statistics) {
        ...
        if (statistics.isStatisticsEnabled()) {
            ...
            Stream.of(collectionRoleNames).forEach(crN -> {
                ...
                cStatMap.put("cache.region.name", createHibernateMetricItem("cacheRegionName",
                        "The name of the region where this data is cached.", cStats.getCacheRegionName()));

                cStatMap.put("cache.hit.count", createHibernateMetricItem("cacheHitCount",
                        "The number of successful cache look-ups for this data from its configured cache region since the last Statistics clearing.",
    ...
    public static SortedMap<String, HibernateMetric> getGenericStats(Statistics statistics) {
        ...
        if (statistics.isStatisticsEnabled()) {
            ...
            // Sessions
            genericStatsMap.put("hibernate-orm.session.opened.count", createHibernateMetricItem("sessionOpenCount",
                    "Global number of sessions opened.", statistics.getSessionOpenCount()));
            genericStatsMap.put("hibernate-orm.session.closed.count", createHibernateMetricItem("sessionCloseCount",
                    "Global number of sessions closed.", statistics.getSessionCloseCount()));

            // Transactions
            genericStatsMap.put("hibernate-orm.transaction.count", createHibernateMetricItem("transactionCount",
                    "The number of transactions we know to have completed.", statistics.getTransactionCount()));
            genericStatsMap.put("hibernate-orm.transaction.successful.count",
                    createHibernateMetricItem("successfulTransactionCount",
                            "The number of transactions we know to have been successful.",
                            statistics.getSuccessfulTransactionCount()));

            // Connections
            genericStatsMap.put("hibernate-orm.connection.obtained.count",
                    createHibernateMetricItem("connectCount",
            ...
            genericStatsMap.put("hibernate-orm.optimistic.lock.failure.count",
                    createHibernateMetricItem("optimisticFailureCount",
            ...
            // Flushes
            genericStatsMap.put("hibernate-orm.flush.count", createHibernateMetricItem("flushCount",
                    "Global number of flush operations executed (either manual or automatic).", statistics.getFlushCount()));

            // Prepared statements
            genericStatsMap.put("hibernate-orm.statement.prepared.count", createHibernateMetricItem("prepareStatementCount",
                    "The number of prepared statements that were acquired.", statistics.getPrepareStatementCount()));
            genericStatsMap.put("hibernate-orm.statement.closed.count", createHibernateMetricItem("closeStatementCount",
                    "The number of prepared statements that were released.", statistics.getCloseStatementCount()));

            // Second level cache
            genericStatsMap.put("hibernate-orm.second-level-cache.put.count",
                    createHibernateMetricItem("secondLevelCachePutCount",
                            "Global number of cacheable entities/collections put in the cache.",
                            statistics.getSecondLevelCachePutCount()));
            genericStatsMap.put("hibernate-orm.second-level-cache.hit.count",
                    createHibernateMetricItem("secondLevelCacheHitCount",
                            "Global number of cacheable entities/collections successfully retrieved from the cache.",
                            statistics.getSecondLevelCacheHitCount()));
            genericStatsMap.put("hibernate-orm.second-level-cache.miss.count", createHibernateMetricItem(
            ...
            genericStatsMap.put("hibernate-orm.entities.load.count", createHibernateMetricItem("entityLoadCount",
                    "Global number of entity loads.", statistics.getEntityLoadCount()));
            genericStatsMap.put("hibernate-orm.entities.update.count", createHibernateMetricItem("entityUpdateCount",
                    "Global number of entity updates.", statistics.getEntityUpdateCount()));
            genericStatsMap.put("hibernate-orm.entities.insert.count", createHibernateMetricItem("entityInsertCount",
                    "Global number of entity inserts.", statistics.getEntityInsertCount()));
            genericStatsMap.put("hibernate-orm.entities.delete.count", createHibernateMetricItem("entityDeleteCount",
                    "Global number of entity deletes.", statistics.getEntityDeleteCount()));
            genericStatsMap.put("hibernate-orm.entities.fetch.count", createHibernateMetricItem("entityFetchCount",
                    "Global number of entity fetches.", statistics.getEntityFetchCount()));

            // Collections
            genericStatsMap.put("hibernate-orm.collections.update.count", createHibernateMetricItem("collectionUpdateCount",
                    "Global number of collections updated.", statistics.getCollectionUpdateCount()));
            genericStatsMap.put("hibernate-orm.collections.remove.count", createHibernateMetricItem("collectionRemoveCount",
                    "Global number of collections removed.", statistics.getCollectionRemoveCount()));
            genericStatsMap.put("hibernate-orm.collections.recreate.count", createHibernateMetricItem("collectionRecreateCount",
                    "Global number of collections recreated.", statistics.getCollectionRecreateCount()));
            genericStatsMap.put("hibernate-orm.collections.fetch.count", createHibernateMetricItem("collectionFetchCount",
                    "Global number of collections fetched.", statistics.getCollectionFetchCount()));
            genericStatsMap.put("hibernate-orm.collections.load.count", createHibernateMetricItem("collectionLoadCount",
                    "Global number of collections loaded.", statistics.getCollectionLoadCount()));

            // Natural id
            genericStatsMap.put("hibernate-orm.natural-id.cache.put.count", createHibernateMetricItem("naturalIdCachePutCount",
                    "Global number of cacheable natural id lookups put in cache.", statistics.getNaturalIdCachePutCount()));
            genericStatsMap.put("hibernate-orm.natural-id.cache.hit.count",
            ...
            genericStatsMap.put("hibernate-orm.natural-id.cache.miss.count",
                    createHibernateMetricItem("naturalIdCacheHitCount",
            ...
            genericStatsMap.put("hibernate-orm.natural-id.query.execution.count",
                    createHibernateMetricItem("naturalIdQueryExecutionCount",
                            "Global number of natural id queries executed against the database.",
                            statistics.getNaturalIdQueryExecutionCount()));
            genericStatsMap.put("hibernate-orm.natural-id.query.execution.maxtime",
                    createHibernateMetricItem("naturalIdQueryExecutionMaxTime",
                            "Max time execution of natural id queries executed against the database.",
                            statistics.getNaturalIdQueryExecutionMaxTime()));
            genericStatsMap.put("hibernate-orm.natural-id.query.execution.maxtime.region",
                    createHibernateMetricItem("naturalIdQueryExecutionMaxTimeRegion",
                            "Max time region of natural id queries executed against the database.",
                            statistics.getNaturalIdQueryExecutionMaxTimeRegion()));
            genericStatsMap.put("hibernate-orm.natural-id.query.execution.maxtime.entity",
                    createHibernateMetricItem("naturalIdQueryExecutionMaxTimeEntity",
                            "Max time entity of natural id queries executed against the database.",
                            statistics.getNaturalIdQueryExecutionMaxTimeEntity()));

            // Queries
            genericStatsMap.put("hibernate-orm.query.execution.count", createHibernateMetricItem("queryExecutionCount",
                    "Global number of executed queries.", statistics.getQueryExecutionCount()));
            genericStatsMap.put("hibernate-orm.query.execution.maxtime", createHibernateMetricItem("queryExecutionMaxTime",
                    "Max execution time of executed queries.", statistics.getQueryExecutionMaxTime()));
            genericStatsMap.put("hibernate-orm.query.cache.put.count", createHibernateMetricItem("queryCachePutCount",
                    "Global number of cacheable queries put in cache.", statistics.getQueryCachePutCount()));
            genericStatsMap.put("hibernate-orm.query.cache.hit.count", createHibernateMetricItem("queryCacheHitCount",
                    "Global number of cached queries successfully retrieved from cache.", statistics.getQueryCacheHitCount()));
            genericStatsMap.put("hibernate-orm.query.cache.miss.count", createHibernateMetricItem("queryCacheMissCount",
                    "Global number of cached queries *not* found in cache.", statistics.getQueryCacheMissCount()));

            // Timestamp
            genericStatsMap.put("hibernate-orm.timestamp.cache.put.count",
                    createHibernateMetricItem("updateTimestampsCachePutCount", "Global number of timestamps put in cache.",
                            statistics.getUpdateTimestampsCachePutCount()));
            genericStatsMap.put("hibernate-orm.timestamp.cache.hit.count",
                    createHibernateMetricItem("updateTimestampsCacheHitCount",
                            "Global number of timestamps successfully retrieved from cache.",
                            statistics.getUpdateTimestampsCacheHitCount()));
            genericStatsMap.put("hibernate-orm.timestamp.cache.miss.count",
                    createHibernateMetricItem("updateTimestampsCacheMissCount",
