 ...
 */
@Stateless
public class TemporaryBuildsCleanupScheduleWorkerImpl implements TemporaryBuildsCleanupScheduleWorker {
    private final Logger log = LoggerFactory.getLogger(TemporaryBuildsCleanupScheduleWorkerImpl.class);
    ...
    @Inject
    public TemporaryBuildsCleanupScheduleWorkerImpl(
        ...
        log.debug("TemporaryBuildsCleanupScheduleWorkerImpl successfully initialized.");
    }
