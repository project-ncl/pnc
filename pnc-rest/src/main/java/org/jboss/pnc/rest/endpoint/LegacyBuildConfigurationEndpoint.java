...
@Api(value = "/project/{projectId}/configuration", description = "Deprecated Build Configuration related information")
@Path("/project/{projectId}/configuration")
@Produces(MediaType.APPLICATION_JSON)
@Consumes(MediaType.APPLICATION_JSON)
public class LegacyBuildConfigurationEndpoint {

    private BuildConfigurationProvider buildConfigurationProvider;
    private BuildRecordProvider buildRecordProvider;

    public LegacyBuildConfigurationEndpoint() {
    }

    @Inject
    public LegacyBuildConfigurationEndpoint(BuildConfigurationProvider buildConfigurationProvider,
    ...
    public List<BuildConfigurationRest> getAll(
        ...
        List<BuildConfigurationRest> allForProject = buildConfigurationProvider.getAllForProject(projectId);
        System.out.println(allForProject);
