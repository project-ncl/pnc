...
@Api(value = "/product/{productId}/version", description = "Product related information")
...
public class ProductVersionEndpoint {
    ...
    @Inject
    public ProductVersionEndpoint(ProductVersionProvider productProviderProvider) {
