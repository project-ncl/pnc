...
public class BuildExecutionConfigurationTest {
    ...
    public void serializeAndDeserializeBuildResult() throws IOException, BuildDriverException {
        ...
        BuildExecutionConfigurationRest buildExecutionConfigurationRestFromJson =
                JsonOutputConverterMapper.readValue(buildExecutionConfigurationJson, BuildExecutionConfigurationRest.class);
