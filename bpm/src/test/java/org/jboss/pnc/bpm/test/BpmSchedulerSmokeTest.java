...
import static org.jboss.pnc.bpm.BpmEventType.BC_CREATION_ERROR;
import static org.jboss.pnc.bpm.BpmEventType.BC_CREATION_SUCCESS;
...
public class BpmSchedulerSmokeTest {
    ...
    public void notificationTest() throws CoreException {
        ...
        task.addListener(BC_CREATION_SUCCESS, t -> {
            assertEquals("green", t.getData().get("color"));
            successNotification = true;
        });
        task.addListener(BC_CREATION_ERROR, t -> {
        ...
        when(notification.getEventType()).thenReturn(BC_CREATION_SUCCESS.getName());
