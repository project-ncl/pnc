...
public class BuildPool {
    ...
    /**
     * The idea behind this algorithm is pretty simple - we are walking through the Build Tree top-down and finally
     * we reverse the order. This way we are building from leafs to root.
     */
