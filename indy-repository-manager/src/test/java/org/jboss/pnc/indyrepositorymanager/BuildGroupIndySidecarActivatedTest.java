...
public class BuildGroupIndySidecarActivatedTest extends AbstractRepositoryManagerDriverTest {

    String sideCarUrl = "https://indy-sidecar:823";
    ...
    public void preConfigureMavenRepositoryDriver(IndyRepoDriverModuleConfig config) {
        config.setIndySidecarEnabled(true);
